...
namespace PNRSched
{
	...
	public partial class GovPascualTaguig : ContentPage
	{
     readonly TrainNumberGPTaguig tno2 = new TrainNumberGPTaguig();
     readonly BICUTAN2 bic = new BICUTAN2();
     readonly FTI2 fti = new FTI2();
     readonly NICHOLS2 nic = new NICHOLS2();
     readonly EDSA2 edsa = new EDSA2();
     readonly PASAYROAD2 pasay = new PASAYROAD2();
     readonly DELAROSA2 delarosa = new DELAROSA2();
     readonly VITOCRUZ2 vitocruz = new VITOCRUZ2();
     readonly SANANDRES2 sanandres = new SANANDRES2();
     readonly PACO2 paco = new PACO2();
     readonly PANDACAN2 pandacan = new PANDACAN2();
     readonly STAMESA2 stamesa = new STAMESA2();
     readonly ESPANA2 espana = new ESPANA2();
     readonly LAONLAAN2 laonlaan = new LAONLAAN2();
     readonly BLUM2 blum = new BLUM2();
     readonly SOLIS2 solis = new SOLIS2();
     readonly C32 c3 = new C32();
     readonly ASSITIO2 ass = new ASSITIO2();
     readonly SDAAN2 sdaan = new SDAAN2();
        readonly GP2 gp = new GP2();
        public GovPascualTaguig ()
		{
			InitializeComponent ();
        ...
        void TrainNumber()
        {
            firstTRAIN.Text = tno2.train1.ToString();
            secondTRAIN.Text = tno2.train2.ToString();
            thirdTRAIN.Text = tno2.train3.ToString();
            fourthTRAIN.Text = tno2.train4.ToString();
            fifthTRAIN.Text = tno2.train5.ToString();
            sixthTRAIN.Text = tno2.train6.ToString();
            seventhTRAIN.Text = tno2.train7.ToString();
            eighthTRAIN.Text = tno2.train8.ToString();
